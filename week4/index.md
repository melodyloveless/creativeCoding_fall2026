...
- Review last week's homework
  - Discuss last week's reading/exploration (Why Program?)
  - Review Iteration Generation
...
- [IDM: More random](https://idmp5.github.io/creative-coding/more-random/){:target="_blank"}
- [IDM: Functions](https://idmp5.github.io/coding/functions/){:target="_blank"}
- [p5.plotSVG GitHub](https://github.com/golanlevin/p5.plotSvg){:target="_blank"}

#### Pen Plotter
- [Inkscape](https://inkscape.org/){:target="_blank"} 
- [iDraw Extension](https://idrawpenplotter.com/pages/downloads){:target="_blank"} 
- [iDraw Setup Guide](https://idmnyu.github.io/DM-GY-6063-A-Creative-Coding-F26/week4/iDraw_Setup_Guide.html){:target="_blank"}
- [Video: "How to use the iDraw plotter with Inkscape"](https://stream.nyu.edu/media/Using+the+iDraw+plotter/1_jxronfno){:target="_blank"} 

### This week's LLM
- [IDM Creative Coding Week 4](https://notebook.google.com/notebook/ba0c7aeb-ba4c-42ec-ab28-fd1e014279bb){:target="_blank"} 

### Study Guide
- [Quiz #1 Study Guide](https://docs.google.com/document/d/1yTr0ltDLhfrtbb4lJJYj2t0m1xYrQzqvpP1buLQGeTo/edit?usp=sharing){:target="_blank"}

---

### Coursework
Before the end of the day on (Th) 9/24:
- Share your weekly reflection via Brightspace.

Before the beginning of next class:
- Install Inkscape and iDraw extension. Review the notes, video, and links for our pen plotter lab.
- Review the [study guide for our upcoming quiz.](https://docs.google.com/document/d/1yTr0ltDLhfrtbb4lJJYj2t0m1xYrQzqvpP1buLQGeTo/edit?usp=sharing){:target="_blank"}
- And complete...
